...
class ShopCard extends StatelessWidget {
  final ModelShop? modelShop;

  ShopCard({this.modelShop, Key? key}) : super(key: key);
                          ...
                          children: [
                            SizedBox(
                              ...
                              CachedNetworkImage(
                                ...
                                imageUrl: 'https://gohookah.ilavista.tech/storage/place_img_sm/${modelShop?.imagee}',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text('${modelShop?.ratee}', style: const TextStyle(color: Color(0xFFC5C5C5))),
                            ...
                            Padding(
                              ...
                              child: TextButton(
                                onPressed: () =>
                                    Clipboard.setData(ClipboardData(text: "${modelShop?.titlee}")).then((value){
                                      final snackBar = SnackBar(
                                        ...
                                        content:
                                        const Text('Название заведения скопировано.', style:
                                        TextStyle
                                            (color: Color
                                ...
                                children:  [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        TextButton(
                                          onPressed: () =>
                                              Clipboard.setData(ClipboardData(text: "${modelShop?.addresss}")).then(
                                                      (value){
                                                final snackBar = SnackBar(
                                                  elevation: 6.0,
                                                  shape: const RoundedRectangleBorder(
                                              ...
                                              child: Text('${modelShop?.addresss}', style:
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      TextButton(
                                          onPressed: () =>
                                              Clipboard.setData(ClipboardData(text: "${modelShop?.phonee}")).then(
                                                      (value){
                                                final snackBar = SnackBar(
                                                  elevation: 6.0,
                                                  shape: const RoundedRectangleBorder(
                                          ...
                                          child: Text('${modelShop?.phonee}', style:
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                              onPressed: () => launch("tel://${modelShop?.phonee}"),
